...
export default function FilterBar({ filters, onFilterChange }) {
  ...
  const getActiveFilterCount = () => {
    return Object.entries(filters).filter(([key, value]) => {
      if (key === 'ageRange') {
        return value.min > 18 || value.max !== null
      }
    ...
    <div className="mb-8">
      ...
      {showFilters && (
        <div className="mt-4 p-6 bg-card border border-border rounded-lg grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {/* Service Type - FIXED: Now matches model's serviceType field */}
          <div>
          ...
          {/* Gender - FIXED: Now matches model's gender field exactly */}
          <div>
          ...
          {/* Body Type - FIXED: Now matches model's bodyType field exactly */}
          <div>
          ...
          {/* Breast Size - FIXED: Now matches model's breastSize field exactly */}
          <div>
          ...
          {/* Serves Who - FIXED: Now matches model's servesWho field */}
          <div>
          ...
          {/* Sexual Orientation - FIXED: Now matches model's sexualOrientation field */}
          <div>
          ...
          {/* Ethnicity - FIXED: Now matches model's ethnicity field */}
          <div>
          ...
          {/* Specific Services - NEW: Filter by specific services offered */}
          <div className="md:col-span-2">
            <label className="block text-sm font-medium text-foreground mb-2">Specific Services</label>
            <select
          ...
          <div className="md:col-span-2 lg:col-span-4 flex justify-between items-center pt-4 border-t border-border">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="px-6 py-2 bg-muted text-foreground rounded-lg font-medium hover:bg-muted/80 transition-all"
              >
                Clear All Filters
              </button>
            </div>
